...
func (k *Key) MarshalJSON() (j []byte, err error) {
	jStruct := plainKeyJSON{
		...
		hex.EncodeToString(sm2crypto.FromECDSA(k.PrivateKey)),
		k.Id.String(),
		version,
	}
...
func (k *Key) UnmarshalJSON(j []byte) (err error) {
	...
	*u, err = uuid.Parse(keyJSON.Id)
	...
	privkey, err := sm2crypto.HexToECDSA(keyJSON.PrivateKey)
	if err != nil {
		return err
	}
...
func NewKeyForDirectICAP(rand io.Reader) *Key {
	...
	privateKeyECDSA, err := ecdsa.GenerateKey(sm2crypto.S256(), reader)
	if err != nil {
