...
func TestV1_2(t *testing.T) {
	...
	addr := common.HexToAddress("bbdb9ffd7b548bf44338cffdcb9bef082551b029")
	file := "testdata/v1/bbdb9ffd7b548bf44338cffdcb9bef082551b029/bbdb9ffd7b548bf44338cffdcb9bef082551b029"
	k, err := ks.GetKey(addr, file, "g")
	if err != nil {
		t.Fatal(err)
	}
	privHex := hex.EncodeToString(sm2crypto.FromECDSA(k.PrivateKey))
